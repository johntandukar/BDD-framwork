...
public class SignInSteps extends CommonUtility{
	...
	Assert.assertTrue(isElementDisplayed(factory.homePage().accountOptions));
	logger.info("User should be logged in Account");
	...
	public void userShouldBeLoggedIntoAccountPage() {
		Assert.assertTrue(isElementDisplayed(factory.signInPage().accountInfo));
